...
model = dict(
    type='CPDet3D_two_stage',
        ...
        # change according your dirs
        pretrained = 'checkpoints/one_stage/scannet/epoch_9.pth',
...
ann_root = '../all_data/scannet_v2/all_sparse_anno/'
data = dict(
    samples_per_gpu=8,
    workers_per_gpu=4,
    train=dict(
        ...
        dataset=dict(
            ...
            data_root=data_root,
            ann_number = '1',
            ann_file=ann_root + 'scannet_infos_train.pkl',
