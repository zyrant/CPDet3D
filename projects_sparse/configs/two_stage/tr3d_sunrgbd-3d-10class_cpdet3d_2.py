...
n_points = 100000
plugin = True
plugin_dir = "projects_sparse/sparse/"

model = dict(
    type='CPDet3D_two_stage',
        model_cfg=dict(
        ...
        transformation = dict(
            ...
            pesudo_nms_pre = 1000, 
            pesudo_iou_thr = 0.5, 
            pesudo_score_thr = 0.2, 
            pesudo_labeled_thr = 0.2,

            pretrained = 'checkpoints/one_stage/sunrgbd/epoch_9.pth',
)
...
ann_root = '../all_data/sunrgbd/all_sparse_anno/'
data = dict(
    samples_per_gpu=16,
    workers_per_gpu=4,
    train=dict(
        ...
        dataset=dict(
            ...
            data_root=data_root,
            ann_number = '1',
            ann_file=ann_root + 'sunrgbd_infos_train.pkl',
    ...
    val=dict(
        ...
        modality=dict(use_camera=False, use_lidar=True),
        data_root=data_root,
        ann_file=ann_root + 'sunrgbd_infos_val.pkl',
